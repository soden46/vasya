...
<head>
    ...
    <title>BINTANG PRADANA PLASTIK | ADMIN </title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home/admin') }}">
                ...
                <div class="sidebar-brand-text mx-3">SIP Biji Plastik</div>
            </a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapseThree" class="collapse " aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-3 collapse-inner rounded">
                        <a class="collapse-item " href="{{ route('laporan/pembelian/bahan/baku') }}">Pembelian Bahan Baku</a>
                        <a class="collapse-item " href="{{ route('laporan/penjualan/barang') }}">Penjualan Barang</a>
                        <a class="collapse-item " href="{{ route('laporan/beban/pengiriman') }}">Beban Pengiriman</a>
                    </div>
                </div>
            </li>
