                    ...
                    <form id="quickForm" action="{{route('barang/create/store')}}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" name="kode_jenis" class="form-control @error('kode_jenis')is-invalid @enderror" id="kode_jenis" placeholder="Masukan Kode Jenis" required value="{{old('kode_jenis')}}" onchange="reSum();">
                                @error('kode_jenis')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" name="satuan" class="form-control @error('satuan')is-invalid @enderror" id="satuan" placeholder="Kg" required value="{{old('satuan')}}" onchange="reSum();">
                                @error('satuan')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
