            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Masukan Data Transaksi Penjualan</h3>
                    </div>
                    <form id="quickForm" action="{{route('penjualan/create/post')}}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="form-floating">
                                <label for="floatingInput">ID Transaksi Penjualan</label>
                                <input type="text" name="id_transaksi_penjualan" class="form-control @error('id_transaksi_penjualan')is-invalid @enderror" id="id_transaksi_penjualan" required value="{{old('id_transaksi_penjualan')}}" onchange="reSum();">
                            ...
                            <div class="form-floating">
                                ...
                                <input type="date" name="tanggal" class="form-control @error('tanggal')is-invalid @enderror" id="tanggal" required value="{{old('tanggal')}}" onchange="reSum();">
                                @error('tanggal')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
