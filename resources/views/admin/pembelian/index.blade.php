...
'pageTitle' => 'Data Transaksi Pembeliang'
])
@section('content')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tabel Data Pembelian Transaksi Pembelian</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <a class="btn btn-primary mb-3" href="{{ route('pembelian/create') }}"><i class="fas fa-fw fa-plus"></i>Tambah</a>
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                    <thead>
                                        <tr>
                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering ID Penjualan: activate to sort column descending">ID Transaksi Pembelian</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering Tanggal Beli: activate to sort column ascending">jumlah</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" style="width:135px">
                                                    <form action="{{ route('pembelian/hapus',$data->id_transaksi_pembelian) }}" method="POST">
                                                        <a class="btn btn-primary" href="{{ route('pembelian/edit',$data->id_transaksi_pembelian) }}">Edit</a>
                                                        @csrf
                                                        @method('POST')
