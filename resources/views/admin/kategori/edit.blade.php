        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{route('kategori/edit/post',$kategori->kode_kategori)}}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="form-floating">
                                <label for="floatingInput">Kode Kategori</label>
                                <input readonly type="text" name="kode_kategori" class="form-control @error('kode_kategori')is-invalid @enderror" id="kode_kategori" required value="{{$kategori->kode_kategori}}">
                                @error('kode_kategori')
