        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{route('kategori/create/post')}}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" name="nama_kategori" class="form-control @error('nama_kategori')is-invalid @enderror" id="nama_kategori" required value="{{old('nama_kategori')}}" onchange="reSum();">
                                @error('nama_kategori')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
